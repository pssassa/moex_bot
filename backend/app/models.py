...
class Instrument(Base):
    ...
    kind: Mapped[str] = mapped_column(String(16), default="share", index=True)
...
class Forecast(Base):
    ...
    chart_analysis: Mapped[str | None] = mapped_column(Text)
    news_alignment: Mapped[str | None] = mapped_column(Text)
